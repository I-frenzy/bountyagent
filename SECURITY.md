...
invariants: the engine's balance always equals open escrow, every USDC in is
either escrowed or paid out exactly once, and no task pays twice. Attack tests
